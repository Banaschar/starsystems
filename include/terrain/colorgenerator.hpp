...
#define DEFAULT_COLOR_PALETTE                                                                                          \
    std::vector<glm::vec4> {                                                                                           \
        glm::vec4(201, 178, 99, 1), glm::vec4(135, 184, 82, 1), glm::vec4(80, 171, 93, 1),                             \
            glm::vec4(120, 120, 120, 1), glm::vec4(200, 200, 210, 1)                                                   \
    }
...
class ColorGenerator {
  public:
    ...
    std::vector<glm::vec4> genColors(std::vector<float> &heights, float dimension, float amplitude = 1.0f);
