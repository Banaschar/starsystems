...
/*
 * It's a LOT easier to just use each side as a quad tree. Trying to move over the sphere with multiple quadTrees is HARD
 * But for really large planets, I can't do it that way
 */
